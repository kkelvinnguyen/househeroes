...
// This component will recieve children as props.
export const AuthProvider = ({ children }: AuthProviderProps) => {
    ...
    // Note: All useEffect functions are called immidiately after the file is loaded.
    useEffect(() => {
    ...
    // Delete the saved suer's info when they logout nad update all screens to null.
    const logout = async () => {
