...
const Leaderboard = () => {
  return (
    <View>
        <View style={{flex: 1, backgroundColor: '#9194EF', marginLeft: 50, marginTop: 30, borderRadius: 10, width: '30%', paddingHorizontal: 10, marginBottom: 50, paddingVertical: 25}} >
          ...
          <View style={{alignSelf: 'center', flex: 1, gap: 15, width: '80%'}}>
            ...
            <View style={{ backgroundColor: 'white', padding: 15, borderRadius: 5, flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', width: '100%' }}>
              <View style={{ width: 30, height: 30, backgroundColor: '#9194EF', borderRadius: 15, justifyContent: 'center', alignItems: 'center', marginRight: 10 }}>
